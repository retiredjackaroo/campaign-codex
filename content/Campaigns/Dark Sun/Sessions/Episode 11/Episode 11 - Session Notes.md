...
The party descended the outer well expecting to set an ambush on pursuing Templars in a tight corridor. Instead, three failed skill checks during the slums crossing told the [[Dregoth Cultists]] that _someone_ had gone down. Rather than send soldiers after an unknown quarry, they dropped a skull into the central shaft, sealed both wells, and left it to do the work. The skull pulled stone and sand into itself and rose as a huge sand elemental between the party and the refugees. It would have been larger still had the party been slower to descend.

The creature's defences reshaped the whole fight. It had **earth instability** (it could not be knocked prone or pushed), it was **immune to the stunned condition**, and it was **largely immune to Web**. What it was _not_ immune to was **Command**, and that single gap decided the encounter.
...
- **Web** ([[Pterrence]]) – the elemental was largely immune and walked through it.
...
[[Her]] does not speak. Her Roll20 chat and her actions are the whole of her voice in a session, so they are worth recording in full. Episode 11's moments:
...
- Base: 943 per character
- Encounter bonus: 200
- Skill check bonus: 100
- **Total: 1,243 XP each**
- 82 cp per character from the gang loot tallied earlier

## Open threads

- [[Korno]] is a prisoner of [[The Templars]]; a rescue is unresolved
- [[The Alliance]] is ahead in the cisterns; a formal alliance is to be secured
