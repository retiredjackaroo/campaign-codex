...
created: 2026-07-20T09:55:38.916+10:00
modified: 2026-07-20T10:09:37.807+10:00
tags:
  - session
  - chapter-11
  - side-quest
...
_Side Quest, Session 1 Notes_

**Summary:** With [[Pug DAstibar|Pug D'Astibar]] left behind in Phlan at the end of Session 1, this side quest fills in what his "personal business" actually was: a secretive mission for [[Elminster]] of [[Shadowdale]], escorted through [[Cormanthor]] towards [[Myth Drannor]] by a separate band of characters. The escort runs into a were-boar hunting party partway through the forest, and the session ends mid-combat. Played by the same table, but with everyone (bar Pug) on secondary side quest characters: see [[Session 1 - Escort to Myth Drannor - Narrative|the narrative]] for the full story, and the new character pages in Characters/Pug's Side Quest/ for who's who.

**Previously On...**

Pug stayed behind near [[Denlors Tower|Denlor's Tower]] at the end of Session 1, promising to keep in touch with the party via Sending through [[Iltiza Ward]]. This session picks up his side of that story.
...
- [[Herschel Blackroot]] opened with Spike Growth, turning a 20-foot radius into thorny difficult terrain (2d4 piercing per 5 feet moved through it).
- [[Pug DAstibar|Pug D'Astibar]] Counterspelled a were-boar shaman's lightning spell, then landed a Chromatic Orb that bounced between a green were-boar and a purple boar for 68 and 19 lightning damage.
- [[Mar]] used Starry Wisp (10 radiant damage, dim light on the shaman) and Shillelagh.
- [[Morwyn Sabbath]] handed out Bardic Inspiration, tried Cutting Words without success, and threw down Faerie Fire to outline several enemies for advantage.
- [[Kjeorn]] used Thunderous Smite and a Shield Bash to knock a boar prone.
- [[Ripper]] landed a critical hit with her whip on a red were-boar (speed reduction, disadvantage on its attacks), then took roughly 47 damage from a charging boar and went down prone. The heaviest hit of the session, by some margin.

**Ongoing Issues**

Several players had vision drop out briefly during the fight (a technical glitch, resolved after a short pause). Jaag's player's own sheet, back on the main character, still has an open question mark over armour class and dexterity bonus, and some equipment (boots of elvenkind, studded leather) has gone missing between sessions; worth a sheet check before the next mainline session.

**Action Items**

- **Pug:** deliver the six crystal vials to the shrine's pool without letting the water touch his skin; keep the silver brooch worn and ready to use.
- **Party:** get Pug through Cormanthor to the shrine, resolve (or route around) the were-boar encounter, and keep the owl familiar out of any dead-magic zones, since it won't follow in.
- **Elminster:** already delivered the vials and the brooch; nothing further outstanding on his end for now.
- **DM:** sort out the vision glitches and the main-campaign sheet issues before the next Moonsea session proper.
